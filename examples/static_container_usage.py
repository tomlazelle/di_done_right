...
class UserService(IUserService):
    def __init__(self, user_repository: IUserRepository, email_service: IEmailService, logger: ILogger):
...
def configure_services(container: DIContainer) -> None:
    ...
    container.register(IUserRepository, DatabaseUserRepository, ServiceLifetime.SINGLETON)
...
def main():
    ...
    print(f"Same logger in both services: {user_service2.logger is user_service3.logger}")
