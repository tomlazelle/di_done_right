...
class TestDIContainer:
    ...
    def test_register_factory(self):
        ...
        container.register_factory(ITestService, create_service, ServiceLifetime.TRANSIENT)
    ...
    def test_concrete_type_dependency_injection(self):
        ...
        container.register(ServiceWithConcreteDependency, lifetime=ServiceLifetime.TRANSIENT)
    ...
    def test_keyed_services_with_scopes(self):
        ...
        container.register_keyed(IPaymentService, "paypal", PayPalService, ServiceLifetime.SCOPED)
        container.register_keyed(IPaymentService, "stripe", StripeService, ServiceLifetime.SCOPED)
