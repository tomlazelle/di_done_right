...
from di_container.service_provider import ServiceProvider, ContainerNotConfiguredException, get_service
...
class TestServiceProvider:
    ...
    def test_already_configured_exception(self):
        ...
        with pytest.raises(Exception):  # Should raise DIException about already configured
    ...
    def test_dependency_injection_through_provider(self):
        ...
        def configure(container: DIContainer):
            container.register(ITestService, TestService, ServiceLifetime.SINGLETON)
            container.register(TestServiceWithDependency, TestServiceWithDependency, ServiceLifetime.TRANSIENT)
    ...
    def test_keyed_services_through_provider(self):
        ...
        def configure(container: DIContainer):
            container.register_keyed(ITestService, "test1", TestService, ServiceLifetime.SINGLETON)
            container.register_keyed(ITestService, "test2", TestService, ServiceLifetime.TRANSIENT)
